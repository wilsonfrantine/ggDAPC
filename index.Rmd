...
In the lines below we will create an layout to shape the plot area and then, we will create these plots, by calling their respective function:
...
The layout is simple to understand. Think about it as a table and the numbers in t, l, b, r indicate the cell where the top, left, bottom, and right will be the respective plot limits. 
